<template>
	<div class="login-container">
		<el-form ref="loginForm" :model="loginForm" :rules="rules" class="login-form">
			...
			<el-form-item prop="id">
				<span class="svg-container">
					<svg t="1594903948207" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4053"
					 width="16" height="16">
			...
			<el-form-item prop="password">
				<span class="svg-container">
					<svg t="1594903789026" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3765"
					 width="16" height="16">
						<path d="M832 464h-68V240c0-70.7-57.3-128-128-128H388c-70.7 0-128 57.3-128 128v224h-68c-17.7 0-32 14.3-32 32v384c0 17.7 14.3 32 32 32h640c17.7 0 32-14.3 32-32V496c0-17.7-14.3-32-32-32zM332 240c0-30.9 25.1-56 56-56h248c30.9 0 56 25.1 56 56v224H332V240z m460 600H232V536h560v304z"
						 p-id="3766" fill="#EEEEEE"></path>
						<path d="M484 701v53c0 4.4 3.6 8 8 8h40c4.4 0 8-3.6 8-8v-53c12.1-8.7 20-22.9 20-39 0-26.5-21.5-48-48-48s-48 21.5-48 48c0 16.1 7.9 30.3 20 39z"
						 p-id="3767" fill="#EEEEEE"></path>
					</svg>
				</span>
				<el-input :key="passwordType" ref="password" v-model="loginForm.password" :type="passwordType" :placeholder="$t('EnterPassword')"
				 tabindex="2" autocomplete="off" @keyup.enter.native="loginHandler" />
				<span class="show-pwd" @click="showPwd">
					<svg v-show="passwordType === 'password'" t="1594906186816" class="icon" viewBox="0 0 1024 1024" version="1.1"
					 xmlns="http://www.w3.org/2000/svg" p-id="4292" width="16" height="16">
						<path d="M942.2 486.2C847.4 286.5 704.1 186 512 186c-192.2 0-335.4 100.5-430.2 300.3-7.7 16.2-7.7 35.2 0 51.5C176.6 737.5 319.9 838 512 838c192.2 0 335.4-100.5 430.2-300.3 7.7-16.2 7.7-35 0-51.5zM512 766c-161.3 0-279.4-81.8-362.7-254C232.6 339.8 350.7 258 512 258c161.3 0 279.4 81.8 362.7 254C791.5 684.2 673.4 766 512 766z"
						 p-id="4293" fill="#EEEEEE"></path>
						<path d="M508 336c-97.2 0-176 78.8-176 176s78.8 176 176 176 176-78.8 176-176-78.8-176-176-176z m0 288c-61.9 0-112-50.1-112-112s50.1-112 112-112 112 50.1 112 112-50.1 112-112 112z"
						 p-id="4294" fill="#EEEEEE"></path>
					</svg>
					<svg v-show="passwordType !== 'password'" t="1594906203171" class="icon" viewBox="0 0 1024 1024" version="1.1"
					 xmlns="http://www.w3.org/2000/svg" p-id="4527" width="16" height="16">
						<path d="M942.3 486.4l-0.1-0.1-0.1-0.1c-36.4-76.7-80-138.7-130.7-186L760.7 351c43.7 40.2 81.5 93.7 114.1 160.9C791.5 684.2 673.4 766 512 766c-51.3 0-98.3-8.3-141.2-25.1l-54.7 54.7C374.6 823.8 439.8 838 512 838c192.2 0 335.4-100.5 430.2-300.3 7.7-16.2 7.7-35 0.1-51.3z m-64-332.2l-42.4-42.4c-3.1-3.1-8.2-3.1-11.3 0L707.8 228.5C649.4 200.2 584.2 186 512 186c-192.2 0-335.4 100.5-430.2 300.3v0.1c-7.7 16.2-7.7 35.2 0 51.5 36.4 76.7 80 138.7 130.7 186.1L111.8 824.5c-3.1 3.1-3.1 8.2 0 11.3l42.4 42.4c3.1 3.1 8.2 3.1 11.3 0l712.8-712.8c3.1-3 3.1-8.1 0-11.2zM398.9 537.4c-1.9-8.2-2.9-16.7-2.9-25.4 0-61.9 50.1-112 112-112 8.7 0 17.3 1 25.4 2.9L398.9 537.4z m184.5-184.5C560.5 342.1 535 336 508 336c-97.2 0-176 78.8-176 176 0 27 6.1 52.5 16.9 75.4L263.3 673c-43.7-40.2-81.5-93.7-114.1-160.9C232.6 339.8 350.7 258 512 258c51.3 0 98.3 8.3 141.2 25.1l-69.8 69.8z"
						 p-id="4528" fill="#EEEEEE"></path>
						<path d="M508 624c-6.4 0-12.7-0.5-18.8-1.6l-51.1 51.1c21.4 9.3 45.1 14.4 69.9 14.4 97.2 0 176-78.8 176-176 0-24.8-5.1-48.5-14.4-69.9l-51.1 51.1c1 6.1 1.6 12.4 1.6 18.8C620 573.9 569.9 624 508 624z"
						 p-id="4529" fill="#EEEEEE"></path>
					</svg>
				</span>
			</el-form-item>
			<el-form-item>
				<div style="display: flex;justify-content: right;padding: 3px 10px;">
					<Verification :tipsColor="'#C0C4CC'" :resetColor="'#EEE'" :dataUrl="exportServerHost + '/verification/data'"
					 :imgPrefix="exportServerHost + '/verification/img/'" :loadDataErrHandler="verifyErr" :clickFinishHandler="verifyFinish"
					 ref="verification" />
				</div>
			</el-form-item>
		...
		<div style = 'z-index: 2002;position: fixed;bottom:0;right: 0;padding:20px;cursor: pointer;'><a href="https://mirren.gitee.io/orion-api-manager-docs/" target="_blank" title="MirrenTools.org developed program Orion-API-Manager" style="color: white;text-decoration: none;">Powered by OAM</a></div>
	</div>
</template>
