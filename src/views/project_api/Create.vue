	...
	<div>
					...
					<div>
						...
						>
							...
							<el-table-column prop="in" label="参数位置" width="120">
								<template v-slot="scope">
									<el-select v-model="scope.row.in" placeholder="请选择">
				...
				<el-form-item label="响应结果">
					<div>
						<div v-for="(resp, idx) in responses" :key="idx" style="border: 1px solid #c6e2ff; padding: 5px;margin-bottom: 5px;">
							...
							<div style="text-align: right;padding-top: 3px;"><el-button size="mini" @click="addResponseData(resp.data)">添加参数</el-button></div>
						</div>
		...
		<el-dialog title="数据编辑" width="80%" style="max-width: 1240px;" :visible.sync="dialogDataEditVisible">
			<el-form :model="parameterData" label-width="100px">
				...
				<el-form-item label="最大值" v-show="isNumber(parameterData.type)"><el-input v-model="parameterData.maxValue" placeholder="最大值"></el-input></el-form-item>
				<el-form-item label="最小值" v-show="isNumber(parameterData.type)"><el-input v-model="parameterData.minValue" placeholder="最小值"></el-input></el-form-item>
				...
				<el-form-item label="正则表达式" v-show="isCanEnumsOrRegex(parameterData.type)"><el-input v-model="parameterData.regex" placeholder="正则表达式"></el-input></el-form-item>
			</el-form>
	...
	data() {
		return {
			...
			apiRules: {
				...
				title: [{ required: true, message: '请输入接口的名称', trigger: 'blur' }]
			},
			parameters: [],
			/**是否显示数据编辑框*/
