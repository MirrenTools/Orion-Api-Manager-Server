	...
	<div style="width: 98%; max-width: 1240px;margin: auto;padding-top: 15px;">
		...
		<div style="margin-top: 20px;" v-show="loaded" v-loading="projectLoading">
			...
			<el-form ref="projectEditForm" :rules="editRules" :model="projectEdit" label-width="120px">
				...
				<el-form-item :label="$t('ExtDocsURL')" prop="exDdescription"><el-input v-model="projectEdit.exDdescription" :placeholder="$t('EnterExtDocsURL')"></el-input></el-form-item>
				<el-form-item :label="$t('ExtDocsDesc')" prop="exDurl"><el-input v-model="projectEdit.exDurl" :placeholder="$t('EnterExtDocsDesc')"></el-input></el-form-item>
			</el-form>
		</div>
